...
app.post('/scrape', async (req: Request, res: Response) => {
  ...
  try {
    // Extract user-agent from headers (case-insensitive) and pass it to createContext,
    // since Playwright ignores user-agent set via setExtraHTTPHeaders after context creation

...
async function scrapeURLLoopIter(
  ...
  try {
    ...
    // Empty content with a good status code is now considered successful (issue #2316)
    // This prevents false positives for "engine failure" conditions when pages are simply empty
    if (isGoodStatusCode) {
